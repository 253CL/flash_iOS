...
/*
 运营商协议，用户多语言配置（顺序需按 【移动】-【联通】-【电信】-【香港移动】排列）
 operatorName：运营商协议名称，
 operatorUrl：运营商协议链接（选填）
 operatorSloganName：运营商slogan文字（选填）
 
 示例：（用户设置需设置至少3个条款，否则设置不生效）
 @[
     @{@"operatorName":@"中国移动认证服务条款11",@"operatorUrl":@"https://xxx",@"operatorSloganName":@"中国移动认证"},
     @{@"operatorName":@"中国联通认证服务条款33",@"operatorUrl":@"https://xxx",@"operatorSloganName":@"中国联通认证"},
     @{@"operatorName":@"中国电信认证服务条款22",@"operatorUrl":@"https:/xxx",@"operatorSloganName":@"中国电信认证"},
     @{@"operatorName":@"中国香港移动认证服务条款44",@"operatorUrl":@"https://wap.cmpassport.com/uni-access/hkContactCm.html?language=SC",@"operatorSloganName":@"中国香港移动认证"}
 ];
 *
 */
@property(nonatomic,strong)NSArray * operatorInfoArray;
